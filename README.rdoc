...
2. The application currently has no user interface. Complete these stories with well-tested code. Don't worry about making it look awesome, just make it work.
